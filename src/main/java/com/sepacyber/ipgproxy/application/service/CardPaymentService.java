...
public class CardPaymentService implements PayWithCardUseCase {
    ...
    public PayWithCardCommandResponse payWithCard(String authToken, PayWithCardCommand payWithCardCommand) {
        //TODO build the card details model
        // Pull customer data
        // enrich command with details from customer-service, wallet
        PayWithCardCommandResponse commandResult = cardPaymentPort.pay(authToken, payWithCardCommand);
